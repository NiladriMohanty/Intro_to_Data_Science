...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    dataCom = pandas.read_csv(hr_by_team_year_sf_la_csv)
    gg = ggplot(dataCom, aes('HR', 'yearID', color='teamID'))+geom_point()+geom_line()+ggtitle('HR vs Year')+ylab('Home Runs')+xlab('Year')
    #print gg
    #YOUR CODE GOES HERE
    return gg
